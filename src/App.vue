<template>
  <v-app>
    <v-container>
      <div class="d-flex flex-column flex-md-row justify-space-between align-center mb-4 pa-4 bg-deep-purple-darken-4">
        <h1 class="text-h4 text-center text-md-left text-white">Kanban Board</h1>
        <v-btn color="inherit" class="mt-2 mt-md-0" @click="openAddForm">
          Add Card
        </v-btn>
      </div>
